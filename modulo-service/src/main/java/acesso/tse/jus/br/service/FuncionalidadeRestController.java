...
public class FuncionalidadeRestController {
	...
	public ResponseEntity<List<FuncionalidadeResource>> findByModuloid(@PathVariable Integer id, Pageable pageable) {
		return new ResponseEntity<>(assembler.toResources(repository.findByModuloid(id, pageable)), HttpStatus.OK);
	}	
