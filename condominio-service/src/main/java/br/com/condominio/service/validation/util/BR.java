package br.com.condominio.service.validation.util;
...
public class BR {
     ...
     * @return
     */
    public static boolean isValidCNPJ(String cpnj) {
        if (cpnj == null || !cpnj.matches("\\d{14}") || cpnj.matches(cpnj.charAt(0) + "{14}")) return false;
        return checkEquals(cpnj, 12, WEIGHT_TFN);
    }
}
